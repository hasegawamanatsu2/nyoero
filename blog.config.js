...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '長谷川まなつ', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '変人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://nyoero.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'nyoero,同人音声', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://z4a.net/images/2024/10/10/QQ20241010104823.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  LAYOUT_MAPPINGS: {
    ...
    '/circle/[circle]': 'LayoutPostList',
    '/circle/[circle]/page/[page]': 'LayoutPostList',
    '/actor/[voiceactor]': 'LayoutPostList',
    '/actor/[voiceactor]/page/[page]': 'LayoutPostList',
    '/search': 'LayoutSearch',
  ...
  IMG_LAZY_LOAD_PLACEHOLDER:
    ...
    'https://www.notion.so/image/https%3A%2F%2Fz4a.net%2Fimages%2F2024%2F10%2F10%2Fimage.png?id=11bdd1df-be34-81c8-99ea-000b221d7c0c&table=collection&spaceId=056340b7-5a1f-4c9c-bfc5-fafa0ba987d4&width=2000&userId=ac641fe0-290b-4356-a72a-a8e6b9e50ff9&cache=v2', // 懒加载占位图片地址，支持base64或url
  IMG_URL_TYPE: process.env.NEXT_PUBLIC_IMG_TYPE || 'Notion', // 此配置已失效，请勿使用；AMAZON方案不再支持，仅支持Notion方案。 ['Notion','AMAZON'] 站点图片前缀 默认 Notion:(https://notion.so/images/xx) ， AMAZON(https://s3.us-west-2.amazonaws.com/xxx)
  IMG_SHADOW: process.env.NEXT_PUBLIC_IMG_SHADOW || false, // 文章图片是否自动添加阴影
  IMG_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMG_COMPRESS_WIDTH || 800, // Notion图片压缩宽度

  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://z4a.net/images/2024/10/10/icon.jpg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || '尿エロ', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '女性受けおしっこ系同人音声', // 站点描述，被notion中的页面描述覆盖
